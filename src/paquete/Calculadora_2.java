...
public class Calculadora_2 extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Calculadora_2.class.getName());
    ...
    public Calculadora_2() {
        initComponents();
        //codigo para que GUI aparezca al centro de la pantalla
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         this.primerNumero = Float.parseFloat(this.casilla.getText()); //el primerNumero en casilla se recibe con gettext y se transforma a un flotante.
        this.operador = "/"; //se asigna el operador /
        this.casilla.setText(""); //casilla vacia
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        // TODO add your handling code here:
        this.casilla.setText(this.casilla.getText() + "0"); //se refiere al formulario con this, despues nombre de variable y settext para recibir info. Se agrega despues gettext para obtener texto.
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        // TODO add your handling code here:
        this.segundoNumero = Float.parseFloat(this.casilla.getText()); //el segundoNumero en casilla se recibe con gettext y se transforma a un flotante.
        
        switch (this.operador) {
            case "+":
                this.casilla.setText(sincero(this.primerNumero + segundoNumero)); //se agrega la funcion y se realizan las operaciones segun el switch
                break;
            case "-":
                this.casilla.setText(sincero(this.primerNumero - segundoNumero));
                break;
            case "*":
                this.casilla.setText(sincero(this.primerNumero * segundoNumero));
                break;
    ...
    //funcion para quitar el cero si no es numero flotante
    ...
    public static void main(String args[]) {
       ...
       /* JFrame splashFrame = new JFrame();
        ...
        ImageIcon gifIcon = new ImageIcon("splash.gif");
        JLabel gifLabel = new JLabel(gifIcon);
        splashFrame.add(gifLabel);

        // Mostrar la ventana
        splashFrame.setVisible(true);
        // ⏱️ Aquí va el tiempo de espera
        try {
        ...
        java.awt.EventQueue.invokeLater(() -> new Calculadora_2().setVisible(true));
    }
